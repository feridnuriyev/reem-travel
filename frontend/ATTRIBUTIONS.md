...
The production site stores locally optimized WebP derivatives of the images below. Keeping this list makes the origin of each stock image clear even though the applicable licences do not require attribution.

- `hero-coast.webp`, `antalya.webp`, `bodrum.webp`, `marmaris.webp`, `fethiye.webp`, `kusadasi.webp`, `cesme.webp`, `tour-sapanca.webp`, and `travel-guide.webp`: [Unsplash](https://unsplash.com/license).
